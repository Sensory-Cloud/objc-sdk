...
typedef GPB_ENUM(GPBFieldDescriptorProto_FieldNumber) {
  ...
  GPBFieldDescriptorProto_FieldNumber_Proto3Optional = 17,
};
 ...
 **/
@property(nonatomic, readwrite) BOOL proto3Optional;

@property(nonatomic, readwrite) BOOL hasProto3Optional;
@end
...
typedef GPB_ENUM(GPBFileOptions_FieldNumber) {
  ...
  GPBFileOptions_FieldNumber_PhpMetadataNamespace = 44,
  GPBFileOptions_FieldNumber_RubyPackage = 45,
 ...
 **/
@property(nonatomic, readwrite, copy, null_resettable) NSString *phpMetadataNamespace;
/** Test to see if @c phpMetadataNamespace has been set. */
@property(nonatomic, readwrite) BOOL hasPhpMetadataNamespace;
 ...
 **/
@property(nonatomic, readwrite, copy, null_resettable) NSString *rubyPackage;
/** Test to see if @c rubyPackage has been set. */
@property(nonatomic, readwrite) BOOL hasRubyPackage;
...
typedef GPB_ENUM(GPBFieldOptions_FieldNumber) {
  ...
  GPBFieldOptions_FieldNumber_UnverifiedLazy = 15,
 ...
 * reasons.
 **/
@property(nonatomic, readwrite) BOOL unverifiedLazy;

@property(nonatomic, readwrite) BOOL hasUnverifiedLazy;
/**
