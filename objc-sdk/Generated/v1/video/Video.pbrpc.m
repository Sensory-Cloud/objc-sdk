...
@implementation SENVVideoModels
...
- (GRPCProtoCall *)RPCToGetModelsWithRequest:(SENVGetModelsRequest *)request handler:(void(^)(SENVGetModelsResponse *_Nullable response, NSError *_Nullable error))handler{
  return [self RPCToMethod:@"GetModels"
            requestsWriter:[GRXWriter writerWithValue:request]
             responseClass:[SENVGetModelsResponse class]
...
@end
@implementation SENVVideoBiometrics
...
- (GRPCProtoCall *)RPCToCreateEnrollmentWithRequestsWriter:(GRXWriter *)requestWriter eventHandler:(void(^)(BOOL done, SENVCreateEnrollmentResponse *_Nullable response, NSError *_Nullable error))eventHandler{
  return [self RPCToMethod:@"CreateEnrollment"
            requestsWriter:requestWriter
             responseClass:[SENVCreateEnrollmentResponse class]
...
- (GRPCProtoCall *)RPCToAuthenticateWithRequestsWriter:(GRXWriter *)requestWriter eventHandler:(void(^)(BOOL done, SENVAuthenticateResponse *_Nullable response, NSError *_Nullable error))eventHandler{
  return [self RPCToMethod:@"Authenticate"
            requestsWriter:requestWriter
             responseClass:[SENVAuthenticateResponse class]
        responsesWriteable:[GRXWriteable writeableWithEventHandler:eventHandler]];
}
/**
 * Authenticates a user with a stream of video against an existing enrollment.
...
@end
@implementation SENVVideoRecognition
...
- (GRPCProtoCall *)RPCToValidateLivenessWithRequestsWriter:(GRXWriter *)requestWriter eventHandler:(void(^)(BOOL done, SENVLivenessRecognitionResponse *_Nullable response, NSError *_Nullable error))eventHandler{
  return [self RPCToMethod:@"ValidateLiveness"
            requestsWriter:requestWriter
             responseClass:[SENVLivenessRecognitionResponse class]
        responsesWriteable:[GRXWriteable writeableWithEventHandler:eventHandler]];
}
/**
 * Validates the liveness of a single image or stream of images.
